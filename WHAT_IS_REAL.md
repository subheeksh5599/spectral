...
| Dashboard (`/app`) | **Real — verified in a browser render** | 240px sidebar, 40px rows, 4 KPI cards, real jobs read from the contract. This is where live state belongs; the landing stays copy |
